	...
	for (var i = 0; i < a; i += 1) {
		...
		if (t == "Walking") {
			if (triggers_list[1] == 0) {
				...
				Y12.popupTip2("Trigger walking set to position ("~trigger_walking_node.getValue()~")",5);
			...
			if (triggers_list[2] == 0) {
				...
				Y12.popupTip2("Trigger running set to position ("~trigger_running_node.getValue()~")",5);
			...
			if (triggers_list[3] == 0) {
				...
				Y12.popupTip2("Trigger backwards set to position ("~trigger_backwards_node.getValue()~")",5);
			...
			if (triggers_list[0] == 0) {
				...
				Y12.popupTip2("Trigger standing set to position ("~trigger_standing_node.getValue()~")",5);
			...
			if (triggers_list[4] == 0) {
				...
				Y12.popupTip2("Trigger falling set to position ("~trigger_falling_node.getValue()~")",5);
			...
			if (triggers_list[5] == 0) {
				...
				Y12.popupTip2("Trigger open-parachute set to position ("~trigger_open_parachute_node.getValue()~")",5);
			...
			if (triggers_list[6] == 0) {
				...
				Y12.popupTip2("Trigger landing set to position ("~trigger_landing_node.getValue()~")",5);
			...
			if (triggers_list[7] == 0) {
				...
				Y12.popupTip2("Trigger crashing set to position ("~trigger_crashing_node.getValue()~")",5);
