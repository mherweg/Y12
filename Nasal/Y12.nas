...
setlistener("sim/model/Y12/lighting/overhead/emission/factor", func(n) { emis_calc = n.getValue() }, 1, 0);
var amb_calc = 0.1;
setlistener("sim/model/Y12/lighting/interior-ambient-factor", func(n) { amb_calc = n.getValue() }, 1, 0);
...
var set_ambient_I = func(i) {
	...
	setprop("sim/model/Y12/lighting/"~livery_cabin_surface[i].pname~"/amb-dif/red", livery_cabin_surface[i].ER * amb_calc);
	...
	if (livery_cabin_surface[i].type == "GB") {
		setprop("sim/model/Y12/lighting/"~livery_cabin_surface[i].pname~"/amb-dif/gb", livery_cabin_surface[i].EG * amb_calc);
	} else {
		livery_cabin_surface[i].EB = livery_cabin_surface[i].AB + (livery_cabin_surface[i].B_add * alert_level * int_switch * power_switch);
		setprop("sim/model/Y12/lighting/"~livery_cabin_surface[i].pname~"/amb-dif/green", livery_cabin_surface[i].EG * amb_calc);
		setprop("sim/model/Y12/lighting/"~livery_cabin_surface[i].pname~"/amb-dif/blue", livery_cabin_surface[i].EB * amb_calc);
	}
}
...
var hatch_lighting_update = func {
	...
	setprop("sim/model/Y12/lighting/door0/interior1-flooring/emission/red", clamp(hatch_interpolate((livery_cabin_surface[1].ER * interior_lighting_base_R), livery_cabin_surface[1].AR, (door0_opening * sa_hatch)) - door0_E_subtract, 0,1));
	setprop("sim/model/Y12/lighting/door0/interior1-flooring/emission/green", clamp(hatch_interpolate((livery_cabin_surface[1].EG * interior_lighting_base_GB), livery_cabin_surface[1].AG, (door0_opening * sa_hatch)) - door0_E_subtract, 0,1));
	setprop("sim/model/Y12/lighting/door0/interior1-flooring/emission/blue", clamp(hatch_interpolate((livery_cabin_surface[1].EB * interior_lighting_base_GB), livery_cabin_surface[1].AB, (door0_opening * sa_hatch)) - door0_E_subtract, 0,1));
	setprop("sim/model/Y12/lighting/door0/interior4-lower-walls/emission/red", hatch_interpolate(0, (livery_cabin_surface[4].ER * interior_lighting_base_R), door0_opening));
	setprop("sim/model/Y12/lighting/door0/interior4-lower-walls/emission/green", hatch_interpolate(0, (livery_cabin_surface[4].EG * interior_lighting_base_GB), door0_opening));
	setprop("sim/model/Y12/lighting/door0/interior4-lower-walls/emission/blue", hatch_interpolate(0, (livery_cabin_surface[4].EB * interior_lighting_base_GB), door0_opening));
	setprop("sim/model/Y12/lighting/door0/interior8-light-frame/emission/red", hatch_interpolate(0, (livery_cabin_surface[8].ER * interior_lighting_base_R), door0_opening));
	setprop("sim/model/Y12/lighting/door0/interior8-light-frame/emission/gb", hatch_interpolate(0, (livery_cabin_surface[8].EG * interior_lighting_base_GB), door0_opening));
	setprop("sim/model/Y12/lighting/door0/hatchA-steps/emission/red", hatch_interpolate(0, (livery_cabin_surface[0].ER * interior_lighting_base_R), door0_opening));
	setprop("sim/model/Y12/lighting/door0/hatchA-steps/emission/gb", hatch_interpolate(0, (livery_cabin_surface[0].EG * interior_lighting_base_GB), door0_opening));

	var door0_A_factor = door0_opening * (1 - int_switch) * sa_hatch * 0.5;
	var door_A_add = int_switch * 0.1;
	setprop("sim/model/Y12/lighting/door0/interior1-flooring/amb-dif/red", (hatch_interpolate((livery_cabin_surface[1].ER * interior_lighting_base_R), livery_cabin_surface[1].AR, door0_opening) * door0_A_factor) + (door_A_add * interior_lighting_base_R));
	setprop("sim/model/Y12/lighting/door0/interior1-flooring/amb-dif/green", (hatch_interpolate((livery_cabin_surface[1].EG * interior_lighting_base_GB), livery_cabin_surface[1].AG, door0_opening) * door0_A_factor) + (door_A_add * interior_lighting_base_GB));
	setprop("sim/model/Y12/lighting/door0/interior1-flooring/amb-dif/blue", (hatch_interpolate((livery_cabin_surface[1].EB * interior_lighting_base_GB), livery_cabin_surface[1].AB, door0_opening) * door0_A_factor) + (door_A_add * interior_lighting_base_GB));
	setprop("sim/model/Y12/lighting/door0/interior4-lower-walls/amb-dif/red", hatch_interpolate((livery_cabin_surface[4].ER * interior_lighting_base_R), livery_cabin_surface[4].AR, door0_opening));
	setprop("sim/model/Y12/lighting/door0/interior4-lower-walls/amb-dif/green", hatch_interpolate((livery_cabin_surface[4].EG * interior_lighting_base_GB), livery_cabin_surface[4].AG, door0_opening));
	setprop("sim/model/Y12/lighting/door0/interior4-lower-walls/amb-dif/blue", hatch_interpolate((livery_cabin_surface[4].EB * interior_lighting_base_GB), livery_cabin_surface[4].AB, door0_opening));
	setprop("sim/model/Y12/lighting/door0/interior8-light-frame/amb-dif/red", hatch_interpolate((livery_cabin_surface[8].ER * interior_lighting_base_R), livery_cabin_surface[8].AR, door0_opening));
	setprop("sim/model/Y12/lighting/door0/interior8-light-frame/amb-dif/gb", hatch_interpolate((livery_cabin_surface[8].EG * interior_lighting_base_GB), livery_cabin_surface[8].AG, door0_opening));

	var door1_opening = clamp(((door1_position - 0.15) * 1.887), 0, 1);
	var door1_E_subtract = door1_opening * (1 - int_switch) * 0.45;
	setprop("sim/model/Y12/lighting/door1/interior1-flooring/emission/red", clamp(hatch_interpolate((livery_cabin_surface[1].ER * interior_lighting_base_R), livery_cabin_surface[1].AR, (door1_opening * sa_hatch)) - door1_E_subtract, 0,1));
	setprop("sim/model/Y12/lighting/door1/interior1-flooring/emission/green", clamp(hatch_interpolate((livery_cabin_surface[1].EG * interior_lighting_base_GB), livery_cabin_surface[1].AG, (door1_opening * sa_hatch)) - door1_E_subtract, 0,1));
	setprop("sim/model/Y12/lighting/door1/interior1-flooring/emission/blue", clamp(hatch_interpolate((livery_cabin_surface[1].EB * interior_lighting_base_GB), livery_cabin_surface[1].AB, (door1_opening * sa_hatch)) - door1_E_subtract, 0,1));
	setprop("sim/model/Y12/lighting/door1/interior4-lower-walls/emission/red", hatch_interpolate(0, (livery_cabin_surface[4].ER * interior_lighting_base_R), door1_opening));
	setprop("sim/model/Y12/lighting/door1/interior4-lower-walls/emission/green", hatch_interpolate(0, (livery_cabin_surface[4].EG * interior_lighting_base_GB), door1_opening));
	setprop("sim/model/Y12/lighting/door1/interior4-lower-walls/emission/blue", hatch_interpolate(0, (livery_cabin_surface[4].EB * interior_lighting_base_GB), door1_opening));
	setprop("sim/model/Y12/lighting/door1/interior8-light-frame/emission/red", hatch_interpolate(0, (livery_cabin_surface[8].ER * interior_lighting_base_R), door1_opening));
	setprop("sim/model/Y12/lighting/door1/interior8-light-frame/emission/gb", hatch_interpolate(0, (livery_cabin_surface[8].EG * interior_lighting_base_GB), door1_opening));
	setprop("sim/model/Y12/lighting/door1/hatchA-steps/emission/red", hatch_interpolate(0, (livery_cabin_surface[0].ER * interior_lighting_base_R), door1_opening));
	setprop("sim/model/Y12/lighting/door1/hatchA-steps/emission/gb", hatch_interpolate(0, (livery_cabin_surface[0].EG * interior_lighting_base_GB), door1_opening));

	var door1_A_factor = door1_opening * (1 - int_switch) * sa_hatch * 0.5;
	setprop("sim/model/Y12/lighting/door1/interior1-flooring/amb-dif/red", (hatch_interpolate((livery_cabin_surface[1].ER * interior_lighting_base_R), livery_cabin_surface[1].AR, door1_opening) * door1_A_factor) + (door_A_add * interior_lighting_base_R));
	setprop("sim/model/Y12/lighting/door1/interior1-flooring/amb-dif/green", (hatch_interpolate((livery_cabin_surface[1].EG * interior_lighting_base_GB), livery_cabin_surface[1].AG, door1_opening) * door1_A_factor) + (door_A_add * interior_lighting_base_GB));
	setprop("sim/model/Y12/lighting/door1/interior1-flooring/amb-dif/blue", (hatch_interpolate((livery_cabin_surface[1].EB * interior_lighting_base_GB), livery_cabin_surface[1].AB, door1_opening) * door1_A_factor) + (door_A_add * interior_lighting_base_GB));
	setprop("sim/model/Y12/lighting/door1/interior4-lower-walls/amb-dif/red", hatch_interpolate((livery_cabin_surface[4].ER * interior_lighting_base_R), livery_cabin_surface[4].AR, door1_opening));
	setprop("sim/model/Y12/lighting/door1/interior4-lower-walls/amb-dif/green", hatch_interpolate((livery_cabin_surface[4].EG * interior_lighting_base_GB), livery_cabin_surface[4].AG, door1_opening));
	setprop("sim/model/Y12/lighting/door1/interior4-lower-walls/amb-dif/blue", hatch_interpolate((livery_cabin_surface[4].EB * interior_lighting_base_GB), livery_cabin_surface[4].AB, door1_opening));
	setprop("sim/model/Y12/lighting/door1/interior8-light-frame/amb-dif/red", hatch_interpolate((livery_cabin_surface[8].ER * interior_lighting_base_R), livery_cabin_surface[8].AR, door1_opening));
	setprop("sim/model/Y12/lighting/door1/interior8-light-frame/amb-dif/gb", hatch_interpolate((livery_cabin_surface[8].EG * interior_lighting_base_GB), livery_cabin_surface[8].AG, door1_opening));
	var doors0_1_opening = (door0_opening + door1_opening) * 0.5;

	var door5_opening = clamp((door5_position * 1.724), 0, 1);
	setprop("sim/model/Y12/lighting/door5/interior-specular", door5_opening);
	...
	setprop("sim/model/Y12/lighting/door5/hatch1-flooring-center/emission/red", livery_cabin_surface[1].ER * f5R);
	setprop("sim/model/Y12/lighting/door5/hatch1-flooring-center/emission/green", livery_cabin_surface[1].EG * f5GB);
	setprop("sim/model/Y12/lighting/door5/hatch1-flooring-center/emission/blue", livery_cabin_surface[1].EB * f5GB);
	setprop("sim/model/Y12/lighting/door5/hatch3-upper-walls/emission/red", livery_cabin_surface[3].ER * f5R);
	setprop("sim/model/Y12/lighting/door5/hatch3-upper-walls/emission/green", livery_cabin_surface[3].EG * f5GB);
	setprop("sim/model/Y12/lighting/door5/hatch3-upper-walls/emission/blue", livery_cabin_surface[3].EB * f5GB);
	setprop("sim/model/Y12/lighting/door5/hatch4-lower-walls/emission/red", livery_cabin_surface[4].ER * f5R);
	setprop("sim/model/Y12/lighting/door5/hatch4-lower-walls/emission/green", livery_cabin_surface[4].EG * f5GB);
	setprop("sim/model/Y12/lighting/door5/hatch4-lower-walls/emission/blue", livery_cabin_surface[4].EB * f5GB);
	setprop("sim/model/Y12/lighting/door5/hatch7-flooring-side/emission/red", livery_cabin_surface[7].ER * f5R);
	setprop("sim/model/Y12/lighting/door5/hatch7-flooring-side/emission/green", livery_cabin_surface[7].EG * f5GB);
	setprop("sim/model/Y12/lighting/door5/hatch7-flooring-side/emission/blue", livery_cabin_surface[7].EB * f5GB);

	setprop("sim/model/Y12/lighting/door5/hatch1-flooring-center/amb-dif/red", livery_cabin_surface[1].AR * door5_opening);
	setprop("sim/model/Y12/lighting/door5/hatch1-flooring-center/amb-dif/green", livery_cabin_surface[1].AG * door5_opening);
	setprop("sim/model/Y12/lighting/door5/hatch1-flooring-center/amb-dif/blue", livery_cabin_surface[1].AB * door5_opening);
	setprop("sim/model/Y12/lighting/door5/hatch3-upper-walls/amb-dif/red", livery_cabin_surface[3].AR * door5_opening);
	setprop("sim/model/Y12/lighting/door5/hatch3-upper-walls/amb-dif/green", livery_cabin_surface[3].AG * door5_opening);
	setprop("sim/model/Y12/lighting/door5/hatch3-upper-walls/amb-dif/blue", livery_cabin_surface[3].AB * door5_opening);
	setprop("sim/model/Y12/lighting/door5/hatch4-lower-walls/amb-dif/red", livery_cabin_surface[4].AR * door5_opening);
	setprop("sim/model/Y12/lighting/door5/hatch4-lower-walls/amb-dif/green", livery_cabin_surface[4].AG * door5_opening);
	setprop("sim/model/Y12/lighting/door5/hatch4-lower-walls/amb-dif/blue", livery_cabin_surface[4].AB * door5_opening);
	setprop("sim/model/Y12/lighting/door5/hatch7-flooring-side/amb-dif/red", livery_cabin_surface[7].AR * door5_opening);
	setprop("sim/model/Y12/lighting/door5/hatch7-flooring-side/amb-dif/green", livery_cabin_surface[7].AG * door5_opening);
	setprop("sim/model/Y12/lighting/door5/hatch7-flooring-side/amb-dif/blue", livery_cabin_surface[7].AB * door5_opening);

	var door5_E_subtract = door5_opening * (1 - int_switch) * 0.45;
	setprop("sim/model/Y12/lighting/door5/interior1-flooring/emission/red", clamp(hatch_interpolate((livery_cabin_surface[1].ER * interior_lighting_base_R), livery_cabin_surface[1].AR, (door5_opening * sa_hatch)) - door5_E_subtract, 0,1));
	setprop("sim/model/Y12/lighting/door5/interior1-flooring/emission/green", clamp(hatch_interpolate((livery_cabin_surface[1].EG * interior_lighting_base_GB), livery_cabin_surface[1].AG, (door5_opening * sa_hatch)) - door5_E_subtract, 0,1));
	setprop("sim/model/Y12/lighting/door5/interior1-flooring/emission/blue", clamp(hatch_interpolate((livery_cabin_surface[1].EB * interior_lighting_base_GB), livery_cabin_surface[1].AB, (door5_opening * sa_hatch)) - door5_E_subtract, 0,1));
	var door5_A_factor = door5_opening * (1 - int_switch) * sa_hatch * 0.5;
	setprop("sim/model/Y12/lighting/door5/interior1-flooring/amb-dif/red", (hatch_interpolate(livery_cabin_surface[1].ER, livery_cabin_surface[1].AR, door5_opening) * door5_A_factor) + (door_A_add * interior_lighting_base_R));
	setprop("sim/model/Y12/lighting/door5/interior1-flooring/amb-dif/green", (hatch_interpolate(livery_cabin_surface[1].EG, livery_cabin_surface[1].AG, door5_opening) * door5_A_factor) + (door_A_add * interior_lighting_base_GB));
	setprop("sim/model/Y12/lighting/door5/interior1-flooring/amb-dif/blue", (hatch_interpolate(livery_cabin_surface[1].EB, livery_cabin_surface[1].AB, door5_opening) * door5_A_factor) + (door_A_add * interior_lighting_base_GB));
	for (var i = 2; i <= 4; i += 1) {
		setprop("sim/model/Y12/lighting/door5/"~livery_cabin_surface[i].pname~"/amb-dif/red", (hatch_interpolate(livery_cabin_surface[i].ER, livery_cabin_surface[i].AR, door5_opening) * door5_A_factor) + (door_A_add * interior_lighting_base_R));
		setprop("sim/model/Y12/lighting/door5/"~livery_cabin_surface[i].pname~"/amb-dif/green", (hatch_interpolate(livery_cabin_surface[i].EG, livery_cabin_surface[i].AG, door5_opening) * door5_A_factor) + (door_A_add * interior_lighting_base_GB));
		setprop("sim/model/Y12/lighting/door5/"~livery_cabin_surface[i].pname~"/amb-dif/blue", (hatch_interpolate(livery_cabin_surface[i].EB, livery_cabin_surface[i].AB, door5_opening) * door5_A_factor) + (door_A_add * interior_lighting_base_GB));
	}
	setprop("sim/model/Y12/lighting/door5/interior8-light-frame/amb-dif/red", (hatch_interpolate(livery_cabin_surface[8].ER, livery_cabin_surface[8].AR, door5_opening) * door5_A_factor) + (door_A_add * interior_lighting_base_R));
	setprop("sim/model/Y12/lighting/door5/interior8-light-frame/amb-dif/gb", (hatch_interpolate(livery_cabin_surface[8].EG, livery_cabin_surface[8].AG, door5_opening) * door5_A_factor) + (door_A_add * interior_lighting_base_GB));
}
...
setlistener("controls/lighting/alert", func {
	...
	if (!alert_switch) {
		setprop("sim/model/Y12/lighting/overhead/emission/red", int_switch);
		setprop("sim/model/Y12/lighting/overhead/emission/gb", int_switch);
	}
...
var set_button_color = func(sbc_prop, sbc_color) {
	if (sbc_color < 0.9 or sbc_color >= 16) {
		...
		setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-k/amb-dif/red", panel_ambient_R * 0.75);	# edge
		setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/face/amb-dif/red", panel_ambient_R);		# face
		setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-b/emission/red", panel_lighting_R * 0.75);	# bright lit
		setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-k/emission/red", panel_lighting_R * 0.33);	# very dark unlit
		setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/face/emission/red", panel_lighting_R * 0.5);	# dark (face)
		setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-k/amb-dif/green", panel_ambient_GB * 0.75);
		setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/face/amb-dif/green", panel_ambient_GB);
		setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-b/emission/green", panel_lighting_GB * 0.75);
		setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-k/emission/green", panel_lighting_GB * 0.33);
		setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/face/emission/green", panel_lighting_GB * 0.5);
		setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-k/amb-dif/blue", panel_ambient_GB * 0.75);
		setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/face/amb-dif/blue", panel_ambient_GB);
		setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-b/emission/blue", panel_lighting_GB * 0.75);
		setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-k/emission/blue", panel_lighting_GB * 0.33);
		setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/face/emission/blue", panel_lighting_GB * 0.5);
		setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/specular", panel_specular);
	} else {
		# button on, determine color
		setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/specular", (1 - power_switch));
		if (sbc_color == 1 or sbc_color == 3) {		# red (or yellow) on
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-k/amb-dif/red", 0.75);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/face/amb-dif/red", 1);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-b/emission/red", button_lit * 0.5);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-k/emission/red", button_lit * 0.5);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/face/emission/red", button_lit);
		} elsif (sbc_color == 9 or sbc_color == 15) {		# half intensity red or grey on
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-k/amb-dif/red", 0.45);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/face/amb-dif/red", 0.6);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-b/emission/red", button_lit * 0.3);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-k/emission/red", button_lit * 0.3);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/face/emission/red", button_lit * 0.6);
		} else {		# red off
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-k/amb-dif/red", 0);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/face/amb-dif/red", 0);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-b/emission/red", 0);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-k/emission/red", 0);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/face/emission/red", 0);
		}
		if (sbc_color == 2 or sbc_color == 3) {		# green (or yellow) on
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-k/amb-dif/green", 0.75);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/face/amb-dif/green", 1);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-b/emission/green", button_lit * 0.5);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-k/emission/green", button_lit * 0.5);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/face/emission/green", button_lit);
		} elsif (sbc_color == 10 or sbc_color == 15) {	# half intensity green or grey on
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-k/amb-dif/green", 0.45);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/face/amb-dif/green", 0.6);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-b/emission/green", button_lit * 0.3);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-k/emission/green", button_lit * 0.3);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/face/emission/green", button_lit * 0.6);
		} else {		# green off
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-k/amb-dif/green", 0);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/face/amb-dif/green", 0);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-b/emission/green", 0);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-k/emission/green", 0);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/face/emission/green", 0);
		}
		if (sbc_color == 4) {		# blue on
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-k/amb-dif/blue", 0.75);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/face/amb-dif/blue", 1);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-b/emission/blue", button_lit * 0.5);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-k/emission/blue", button_lit * 0.5);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/face/emission/blue", button_lit);
		} elsif (sbc_color == 15) {		# grey on
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-k/amb-dif/blue", 0.45);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/face/amb-dif/blue", 0.6);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-b/emission/blue", button_lit * 0.3);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-k/emission/blue", button_lit * 0.3);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/face/emission/blue", button_lit * 0.6);
		} else {		# blue off
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-k/amb-dif/blue", 0);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/face/amb-dif/blue", 0);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-b/emission/blue", 0);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/edge-k/emission/blue", 0);
			setprop("sim/model/Y12/lighting/buttons/" ~ sbc_prop ~ "/face/emission/blue", 0);
		}
	}
}
...
var panel_lighting_update = func {
	...
	var ipll = getprop("sim/model/Y12/lighting/landing-lights");
	...
	var ipnl = getprop("sim/model/Y12/lighting/nav-light-switch");
